...
using DingTalkApi.Models.Contacts.CooperateCorps;
using DingTalkApi.Models.Contacts.ContactUsers;
using DingTalkApi.Models.Contacts.DepartmentManage;
...
public class ContactsApiSyncTests : TestBase
{
    ...
    public void ContactsModelProperties_ShouldHaveXmlSummaryComments()
    {
        var contactsModelRoot = FindRepositoryRoot()
            .GetDirectories("DingTalkApi", SearchOption.TopDirectoryOnly)
            .Single()
    ...
    public static IEnumerable<object[]> ContactsModelTypeData()
    {
        return typeof(ContactUsersUnionIdGetRequest).Assembly
            ...
            .Where(type => type.IsClass &&
                           ...
                           type.Namespace.StartsWith("DingTalkApi.Models.Contacts.", StringComparison.Ordinal))
    ...
    private static DirectoryInfo FindRepositoryRoot()
    {
        ...
        while (directory is not null && directory.GetFiles("DingTalkApi.slnx").Length == 0)
        {
